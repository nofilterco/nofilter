...
def dump_launch_report(path: str = "launch_report.json") -> str:
    rows = load_rows()
    payload = [{
        "collection": r["collection_slug"], "title": r["listing_title"], "tags": r["tags_csv"],
